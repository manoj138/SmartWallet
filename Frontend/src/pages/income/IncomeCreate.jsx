...
import { 
  ...
  IoCalendarOutline, IoTimeOutline, IoCheckmarkCircleOutline 
...
const IncomeCreate = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#050505] text-white p-6 relative overflow-hidden font-sans">
      ...
      <div className="absolute bottom-[-10%] left-[-10%] w-[400px] h-[400px] bg-indigo-600/10 rounded-full blur-[120px] pointer-events-none"></div>
      ...
      >
        ...
        <div className="backdrop-blur-3xl bg-white/[0.02] border border-white/[0.08] rounded-[2.5rem] p-10 shadow-2xl relative overflow-hidden">
          ...
          <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-emerald-500 to-indigo-600"></div>

          <header className="mb-10 text-center">
            <div className="w-16 h-16 bg-emerald-500/10 rounded-2xl flex items-center justify-center text-emerald-400 border border-emerald-500/20 mx-auto mb-4 shadow-xl">
            ...
            <p className="text-gray-500 text-[10px] font-bold uppercase tracking-[0.2em] mt-2">New credit transaction</p>
          </header>
            ...
            <div className="relative group">
              ...
              <div className="flex items-center gap-3 px-5 py-4 bg-white/[0.03] border border-white/10 rounded-2xl group-focus-within:border-emerald-500/50 transition-all shadow-inner">
                ...
                <input
                  ...
                  required
                  className="bg-transparent outline-none w-full text-sm font-medium placeholder:text-gray-700"
                />
              </div>
            </div>
