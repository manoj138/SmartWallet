  ...
  return (
    <div className="sticky top-0 z-[60] w-full bg-transparent px-6 py-4">
      ...
      <nav className="mx-auto max-w-7xl relative">
        ...
        <div className="relative flex justify-between items-center px-8 py-3 bg-[#050505]  border border-white/[0.08] rounded-full shadow-2xl">
          ...
          <div className="relative">
            ...
            >
              ...
              <div className="hidden md:block">
                <p className="text-[9px] text-gray-500 font-black uppercase tracking-[0.2em] leading-none mb-1">
                  Account
                </p>
                <p className="text-sm text-gray-100 font-bold tracking-tight leading-none">
                  {user?.name}
                </p>
              </div>
